      ...
      <div class="site-info">
        <el-row>
          <el-col :span="3" :offset="2" class="footer-col">
            ...
            <router-link to='/managerhome'>管理后台</router-link>
          ...
          <el-col :span="3" class="footer-col">
            ...
            <a target="_blank" href="https://github.com/asw5757257/online_exam/issues">反馈建议</a>
          </el-col>
          <el-col :span="7" class="footer-col">
            ...
            <div class="we-chat-new">
              <img src="../../assets/imags/wechat.jpg" alt="">
              作者微信
            </div>
          </el-col>
        </el-row>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .footer-col {
    ...
    .we-chat-new {
      ...
      padding-top: 0px;
      color: #ffffff;
    //   background-image: url("../../assets/imags/wechat.jpg") ;
    //   background-repeat: no-repeat;
    // background: url(../../assets/imags/wechat.jpg) no-repeat;
